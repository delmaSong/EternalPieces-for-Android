 ...
 */
public class ChatListTattooerAdapter extends RecyclerView.Adapter{

    private List<ItemChatListTattooer> mDataList;
    public Context context;

    public ChatListTattooerAdapter(List<ItemChatListTattooer> mDataList) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext())
                .inflate(R.layout.item_chat_list_tattooer, viewGroup, false);
        context = viewGroup.getContext();
        return new ChatListTattooerAdapter.MyRecyclerViewHolder(view);
    }
