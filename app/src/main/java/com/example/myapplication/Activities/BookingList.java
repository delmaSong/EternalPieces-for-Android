...
//    Button btnChatList;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_booking_list_tattooer);
...
//        btnChatList = (Button)findViewById(R.id.btn_chat_list);
        ...
        }else if(!sp_booking_tattooer.contains(userId) || !sp_booking_tattooist.contains(userId)){
            AlertDialog.Builder builder = new AlertDialog.Builder(BookingList.this);
        ...
        if(!userId.isEmpty()){
            //타투이스트로 로그인한거라면
            if(user.isTon()){
                Toast.makeText(getApplicationContext(), "상단 버튼 클릭시 시술 받는 정보 확인 가능합니다", Toast.LENGTH_SHORT).show();
                ...
                tb_booking.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent = new Intent(BookingList.this, BookingListTattooistGetTattoo.class);
                        startActivity(intent);
                        finish();
                        Log.d("intent from BookingList", "to GetTattooList");
                    }
                });
            }else{  //타투이스트로 로그인한게 아니라면
                tb_booking.setTextOff("타투 시술 하는 예약정보");
                tb_booking.setTextOn("타투 시술 하는 예약정보");
                //마이페이지 버튼 숨김
    ...
    protected void onResume(){
        ...
        btnFindStyle.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(BookingList.this, FindStyleActivity.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        btnFindArtist.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(BookingList.this, FindArtistActivity.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        btnMypage.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(BookingList.this, MypageDesign.class);
                startActivity(intent);
                finish();
            }
        });
...
//        });
        ...
        btnBookingList.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(BookingList.this, BookingList.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        btnUploadDesign.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(BookingList.this, UploadDesign.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        btnUploadWork.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(BookingList.this, UploadWork.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        btnLike.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(BookingList.this, LikeDesign.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        set_time.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(BookingList.this, SetWorktime.class);
                startActivity(intent);
            }
        });
        ...
        btn_logout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!sp_login.contains("login_ok")){
                    Intent intent = new Intent(BookingList.this, LoginActivity.class);
                    startActivity(intent);
                    ...
                    builder.setPositiveButton("네", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            editor_login.clear();
                            editor_login.apply();
                            Intent intent = new Intent(BookingList.this, MainActivity.class);
                            startActivity(intent);
                            finish();
                        }
                    });
...
//            photoUri = tattooerBooking.chageUri();
//            bk_design = photoUri.toString();
