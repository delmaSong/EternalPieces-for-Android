...
//            dataList.remove(new Design(delete_title, delete_photo, delete_comment, delete_key));
    ...
    protected void onResume(){
        ...
        btnMypage.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(FindStyleCoverUpActivity.this, MypageDesign.class);
                startActivity(intent);
                finish();
            }
        });
...
//        });
        ...
        btnBookingList.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(FindStyleCoverUpActivity.this, BookingList.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        set_time.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(FindStyleCoverUpActivity.this, SetWorktime.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        btn_logout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!sp_login.contains("login_ok")){
                    Intent intent = new Intent(FindStyleCoverUpActivity.this, LoginActivity.class);
                    startActivity(intent);
                }else{      //로그인 중이라면 sp_login 값 삭제
                    AlertDialog.Builder builder = new AlertDialog.Builder(FindStyleCoverUpActivity.this);
                    ...
                    builder.setPositiveButton("네", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            editor_login.clear();
                            editor_login.apply();
                            Intent intent = new Intent(FindStyleCoverUpActivity.this, MainActivity.class);
                            startActivity(intent);
                            finish();
                        }
                    });
