...
public class TattooistMypageDesign extends AppCompatActivity {
...
//    Button btnChatList;
    ...
    //sharedPreference
    SharedPreferences sp_tattooist, sp_login, sp_design, sp_user, sp_like_artist;
    SharedPreferences.Editor editor, like_editor, editor_login;
    Gson gson;
    String json_tattooist, json_design, json_user, json;
    Tattooist tattooist;
    Design design;
    String tattooistId;
...
//    Like like;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mypage_tattooist_design);
    ...
    //    쉐어드에 담겨진 디자인키값과 뿌려지는 디자인 키값 중 같은 것은 하트 색칠
        ...
        btn_edit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(TattooistMypageDesign.this);
                builder.setTitle("수정하시겠습니까?");
                builder.setPositiveButton("수정", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        //수정시 인텐트로 들고가야 할 내용들 세팅
                        Intent intent = new Intent(TattooistMypageDesign.this, TattooistMypageEdit.class);
...
//        dataList.add(new Design(str_img));
    ...
    protected void onResume(){
        ...
        btn_design.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(TattooistMypageDesign.this, TattooistMypageDesign.class);
                intent.putExtra("tattooist_key", tattooistId);
                startActivity(intent);
                finish();
            }
        ...
        btn_work.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(TattooistMypageDesign.this, TattooistMypageWork.class);
                intent.putExtra("tattooist_key", tattooistId);
        ...
        btn_review.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(TattooistMypageDesign.this, TattooistMypageReview.class);
                intent.putExtra("tattooist_key", tattooistId);
                startActivity(intent);
                finish();
            }
        ...
        btnFindStyle.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(TattooistMypageDesign.this, FindStyleActivity.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        btnFindArtist.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(TattooistMypageDesign.this, FindArtistActivity.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        btnMypage.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(TattooistMypageDesign.this, MypageDesign.class);
                startActivity(intent);
                finish();
            }
        });
...
//        });
        ...
        btnBookingList.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(TattooistMypageDesign.this, BookingList.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        btnUploadDesign.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(TattooistMypageDesign.this, UploadDesign.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        btnUploadWork.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(TattooistMypageDesign.this, UploadWork.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        btnLike.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(TattooistMypageDesign.this, LikeDesign.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        set_time.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(TattooistMypageDesign.this, SetWorktime.class);
                startActivity(intent);
            }
        });
        ...
        btn_logout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!sp_login.contains("login_ok")){
                    Intent intent = new Intent(TattooistMypageDesign.this, LoginActivity.class);
                    startActivity(intent);
                    ...
                    builder.setPositiveButton("네", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            editor_login.clear();
                            editor_login.apply();
                            Intent intent = new Intent(TattooistMypageDesign.this, MainActivity.class);
                            startActivity(intent);
                            finish();
                        }
                    });
