...
public class FindStyleBGActivity extends AppCompatActivity {
...
//    Button btnChatList;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_find_style_black_gray);
...
//        btnChatList = (Button)findViewById(R.id.btn_chat_list);
        ...
        dl = (DrawerLayout)findViewById(R.id.dl_find_style_bg);
...
//            dataList.remove(new Design(delete_title, delete_photo, delete_comment, delete_key));
    ...
    protected void onResume(){
        ...
        btn_waterColor.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(FindStyleBGActivity.this, FindStyleActivity.class);
        ...
        btn_blackNgray.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(FindStyleBGActivity.this, FindStyleBGActivity.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        btn_coverUp.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(FindStyleBGActivity.this, FindStyleCoverUpActivity.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        btn_crayon.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(FindStyleBGActivity.this, FindStyleCrayonActivity.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        btn_lettering.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(FindStyleBGActivity.this, FindStyleLetteringActivity.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        btnFindArtist.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(FindStyleBGActivity.this, FindArtistActivity.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        btnMypage.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(FindStyleBGActivity.this, MypageDesign.class);
                startActivity(intent);
                finish();
            }
        });
...
//            @Override
//            public void onClick(View v) {
//                Intent intent = new Intent(FindStyleBGActivity.this, TattooistChatList.class);
...
//        });
        ...
        btnBookingList.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(FindStyleBGActivity.this, BookingList.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        btnUploadDesign.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(FindStyleBGActivity.this, UploadDesign.class);
        ...
        btnUploadWork.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(FindStyleBGActivity.this, UploadWork.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        btnLike.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(FindStyleBGActivity.this, LikeDesign.class);
                startActivity(intent);
            }
        });
        ...
        set_time.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(FindStyleBGActivity.this, SetWorktime.class);
                startActivity(intent);
            }
        });
        ...
        btn_logout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!sp_login.contains("login_ok")){
                    Intent intent = new Intent(FindStyleBGActivity.this, LoginActivity.class);
                    startActivity(intent);
                }else{      //로그인 중이라면 sp_login 값 삭제
                    AlertDialog.Builder builder = new AlertDialog.Builder(FindStyleBGActivity.this);
                    ...
                    builder.setPositiveButton("네", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            editor_login.clear();
                            editor_login.apply();
                            Intent intent = new Intent(FindStyleBGActivity.this, MainActivity.class);
                            startActivity(intent);
                            finish();
                        }
                    });
