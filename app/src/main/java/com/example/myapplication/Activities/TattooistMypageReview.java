...
public class TattooistMypageReview extends AppCompatActivity {
...
//    Button btnChatList;
    ...
    //shared preference
    SharedPreferences sp_user, sp_login, sp_review, sp_like_artist, sp_tattooist;
    SharedPreferences.Editor editor_login, like_editor;
    Gson gson = new Gson();
    String json_user, json_review, json_tattooist, json;
    ...
    public static String stt_tattooistId;

    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_mypage_tattooist_review);
...
//        btnChatList = (Button)findViewById(R.id.btn_chat_list);
        ...
        if(tattooist.getBackgroundPhoto() != null){
            ...
            String str_img = tattooist.getBackgroundPhoto();
...
//            photoUri = review.chageUri();
//            tmp_photo = photoUri.toString();
...
//                userList.add(entry.getKey());
            ...
            Log.d("tattooistId is", tattooistId);
    ...
    protected void onResume(){
        ...
        btn_design.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(TattooistMypageReview.this, TattooistMypageDesign.class);
        ...
        btn_work.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(TattooistMypageReview.this, TattooistMypageWork.class);
                intent.putExtra("tattooist_key", tattooistId);
                startActivity(intent);
                finish();
            }
        ...
        btn_review.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(TattooistMypageReview.this, TattooistMypageReview.class);
                intent.putExtra("tattooist_key", tattooistId);
                startActivity(intent);
                finish();
            }
        ...
        btnFindStyle.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(TattooistMypageReview.this, FindStyleActivity.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        btnFindArtist.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(TattooistMypageReview.this, FindArtistActivity.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        btnMypage.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(TattooistMypageReview.this, MypageDesign.class);
                startActivity(intent);
                finish();
            }
        });
...
//        });
        ...
        btnBookingList.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(TattooistMypageReview.this, BookingList.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        btnUploadDesign.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(TattooistMypageReview.this, UploadDesign.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        btnUploadWork.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(TattooistMypageReview.this, UploadWork.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        btnLike.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(TattooistMypageReview.this, LikeDesign.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        set_time.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(TattooistMypageReview.this, SetWorktime.class);
                startActivity(intent);
            }
        });
        ...
        btn_logout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!sp_login.contains("login_ok")){
                    Intent intent = new Intent(TattooistMypageReview.this, LoginActivity.class);
                    startActivity(intent);
                }else{      //로그인 중이라면 sp_login 값 삭제
                    AlertDialog.Builder builder = new AlertDialog.Builder(TattooistMypageReview.this);
                    ...
                    builder.setPositiveButton("네", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            editor_login.clear();
                            editor_login.apply();
                            Intent intent = new Intent(TattooistMypageReview.this, MainActivity.class);
                            startActivity(intent);
                            finish();
                        }
                    });
